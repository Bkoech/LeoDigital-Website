...
@if ($crud->checkIfFieldIsFirstOfItsType($field, $fields))
    ...
    tinymce.init({
        ...
        skin: "dick-light",
        plugins: "advlist,anchor,autolink,autoresize,charmap,code,colorpicker,contextmenu,directionality,example,example_dependency,hr,image,insertdatetime,layer,legacyoutput,link,lists,nonbreaking,noneditable,pagebreak,paste,preview,searchreplace,spellchecker,tabfocus,table,textcolor,textpattern,visualblocks,visualchars,wordcount",
